...
<body style = "background: linear-gradient(45deg, #e6e6fa, #afaffa)">
	...
	<div>
		...
		<table style="margin: auto; padding-bottom: 100px;">
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">購入者氏名</th>
				<td style="width: 400px; background-color: #EEEEEE;">山田太郎</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">購入者メールアドレス</th>
				<td style="width: 400px; background-color: #EEEEEE;">sample@sample.com</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">購入者住所</th>
				<td style="width: 400px; background-color: #EEEEEE;">〒111-11111愛知県名古屋市○○区××</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">購入した商品</th>
				<td style="width: 400px; background-color: #EEEEEE;">ユニフォームA</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">購入数</th>
				<td style="width: 400px; background-color: #EEEEEE;">11</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">注文日</th>
				<td style="width: 400px; background-color: #EEEEEE;">2024/07/01</td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">入金状況</th>
				<td style="width: 400px; background-color: #EEEEEE;"><a href="<%=request.getContextPath()%>/view/update.jsp">入金待ち</a></td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">発送状況</th>
				<td style="width: 400px; background-color: #EEEEEE;"><a href="<%=request.getContextPath()%>/view/update.jsp">未発送</a></td>
			</tr>
			<tr>
				<th
					style="text-align: center; background-color: #BBBBBB; width: 200px; height: 30px;">備考欄</th>
